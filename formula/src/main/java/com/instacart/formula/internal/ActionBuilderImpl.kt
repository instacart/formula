...
internal class ActionBuilderImpl<out Input, State> internal constructor(
    ...
    override fun <Event> events(
        ...
        // Register directly with ActionManager instead of collecting into set
    ...
    private fun <Event> toBoundStream(
        ...
        // Register directly with ActionManager
        // This marks the action as requested and schedules it for starting if new
